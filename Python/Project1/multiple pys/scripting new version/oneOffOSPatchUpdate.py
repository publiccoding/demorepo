...
class OneOffPatches:
	...
	def initialize(self, executablePath):
		...
		try:
			...
			print(RED + "Unable to open the program's resource file for reading; check the log file for additional information." + RESETCOLORS)
			logger.error("Unable to open the program's resource file for reading: " + str(err))
			exit(1)	
